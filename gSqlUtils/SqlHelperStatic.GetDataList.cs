...
namespace gpower2.gSqlUtils
{
    public static partial class SqlHelperStatic
    {
        ...
        public static IEnumerable GetDataList(Type argObjectType, string argSqlCode, SqlConnection argSqlCon)
        {
        ...
        /// <returns>The List of objects filled with data</returns>
        public static IEnumerable GetDataList(Type argObjectType, string argSqlCode, SqlConnection argSqlCon, int argTimeout)
        {
        ...
        /// <returns>The List of objects filled with data</returns>
        public static IEnumerable GetDataList(Type argObjectType, string argSqlCode, SqlConnection argSqlCon, SqlTransaction argSqlTransaction)
        {
        ...
        /// <returns>The List of objects filled with data</returns>
        public static IEnumerable GetDataList(Type argObjectType, string argSqlCode, SqlConnection argSqlCon, int argTimeout, SqlTransaction argSqlTransaction, List<SqlParameter> argSqlParameters)
        {
        ...
        /// <param name="argSqlCon">The SQL connection to use</param>
        /// <returns>The List of objects filled with data</returns>
        public static IEnumerable<T> GetDataList<T>(string argSqlCode, SqlConnection argSqlCon)
        {
        ...
        /// <param name="argTimeout">The timeout for the SQL command in seconds</param>
        /// <returns>The List of objects filled with data</returns>
        public static IEnumerable<T> GetDataList<T>(string argSqlCode, SqlConnection argSqlCon, int argTimeout)
        {
        ...
        /// <param name="argSqlTransaction">The SQL transaction to use</param>
        /// <returns>The List of objects filled with data</returns>
        public static IEnumerable<T> GetDataList<T>(string argSqlCode, SqlConnection argSqlCon, SqlTransaction argSqlTransaction)
        {
        ...
        /// <param name="argSqlParameters">The SQL Parameters for the SQL command</param>
        /// <returns>The List of objects filled with data</returns>
        public static IEnumerable<T> GetDataList<T>(string argSqlCode, SqlConnection argSqlCon, int argTimeout, SqlTransaction argSqlTransaction, List<SqlParameter> argSqlParameters)
        {
            // Return our list
            return (IEnumerable<T>)GetDataList(typeof(T), argSqlCode, argSqlCon, argTimeout, argSqlTransaction, argSqlParameters);
        }
